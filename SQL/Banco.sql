...
/****** Object:  Database [Credit]    Script Date: 26/06/2022 22:25:13 ******/
CREATE DATABASE [Credit]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Credit', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Credit.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Credit_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Credit_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Credit] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Credit] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Credit] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [Credit] SET QUERY_STORE = OFF
GO
